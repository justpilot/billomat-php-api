...
$mapping = [
    ...
    'eingangsrechnungen/kategorien' => ['note' => 'Kategorien (read-only Endpoint); noch kein dediziertes Api.'],
    ...
    'einstellungen/steuerfreie-laender' => ['note' => 'Steuerfreie Länder – noch kein Api.'],
    'einstellungen/einheiten' => ['api' => 'UnitsApi'],
    'einstellungen/email-vorlagen' => ['api' => 'EmailTemplatesApi'],
    'einstellungen/freitexte' => ['api' => 'FreeTextsApi'],
    ...
    'einstellungen/mahnstufen' => ['api' => 'DunningLevelsApi'],
    'einstellungen/rollen' => ['note' => 'Rollen-Verwaltung – noch kein Api.'],
