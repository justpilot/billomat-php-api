...
/**
 * Position einer Gutschrift (Credit Note Item).
 *
 * Doku: https://www.billomat.com/en/api/credit-notes/items/
 */
final readonly class CreditNoteItem
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            creditNoteId: isset($data['credit_note_id']) ? (int) $data['credit_note_id'] : null,
